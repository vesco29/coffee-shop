...
import db
from common import get_birthday_customer, load_table
...
class TestingDBLoad(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_load_seles(self):
        ...
        available = [dict(row)  for row in available]
        self.assertListEqual(available, 
                           [{'transaction_id': 1,'id': 1, 'transaction_date': datetime.date(2019, 3, 1), 'transaction_time': datetime.time(12, 4, 43), 'transaction_datetime': datetime.datetime(2019, 3, 1, 12, 4, 43), 'sales_outlet_id': 3, 'staff_id': 12, 'customer_id': 1, 'instore_yn': 'N', 'order': 1, 'line_item_id': 1, 'product_id': 52, 'quantity': 1, 'line_item_amount': 2.5, 'unit_price': 2.5, 'promo_item_yn': 'N'}, 
                            {'transaction_id': 2, 'id': 2,'transaction_date': datetime.date(2019, 4, 1), 'transaction_time': datetime.time(15, 54, 39), 'transaction_datetime': datetime.datetime(2019, 4, 1, 15, 54, 39), 'sales_outlet_id': 3, 'staff_id': 17, 'customer_id': 1, 'instore_yn': 'N', 'order': 1, 'line_item_id': 1, 'product_id': 27, 'quantity': 2, 'line_item_amount': 7.0, 'unit_price': 3.5, 'promo_item_yn': 'N'}, 
                            {'transaction_id': 3, 'id': 3,'transaction_date': datetime.date(2019, 6, 1), 'transaction_time': datetime.time(14, 34, 59), 'transaction_datetime': datetime.datetime(2019, 6, 1, 14, 34, 59), 'sales_outlet_id': 3, 'staff_id': 17, 'customer_id': 1, 'instore_yn': 'Y', 'order': 1, 'line_item_id': 1, 'product_id': 46, 'quantity': 2, 'line_item_amount': 5.0, 'unit_price': 2.5, 'promo_item_yn': 'N'}, 
                            {'transaction_id': 4, 'id': 4,'transaction_date': datetime.date(2019, 4, 1), 'transaction_time': datetime.time(16, 6, 4), 'transaction_datetime': datetime.datetime(2019, 4, 1, 16, 6, 4), 'sales_outlet_id': 3, 'staff_id': 12, 'customer_id': 2, 'instore_yn': 'N', 'order': 1, 'line_item_id': 1, 'product_id': 23, 'quantity': 2, 'line_item_amount': 5.0, 'unit_price': 2.5, 'promo_item_yn': 'N'}, 
                            {'transaction_id': 5, 'id': 5,'transaction_date': datetime.date(2019, 4, 1), 'transaction_time': datetime.time(16, 18, 37), 'transaction_datetime': datetime.datetime(2019, 4, 1, 16, 18, 37), 'sales_outlet_id': 3, 'staff_id': 17, 'customer_id': 2, 'instore_yn': 'Y', 'order': 1, 'line_item_id': 1, 'product_id': 34, 'quantity': 1, 'line_item_amount': 2.45, 'unit_price': 2.45, 'promo_item_yn': 'N'}, 
                            {'transaction_id': 6,'id': 6, 'transaction_date': datetime.date(2019, 4, 1), 'transaction_time': datetime.time(18, 54, 46), 'transaction_datetime': datetime.datetime(2019, 4, 1, 18, 54, 46), 'sales_outlet_id': 3, 'staff_id': 17, 'customer_id': 664, 'instore_yn': 'Y', 'order': 1, 'line_item_id': 1, 'product_id': 32, 'quantity': 1, 'line_item_amount': 3.0, 'unit_price': 3.0, 'promo_item_yn': 'N'}])
